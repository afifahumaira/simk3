...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::prefix('daftarinvestigasi')->name('daftarinvestigasi.')->group(function(){
        ...
        Route::put('update/{laporinsiden_id}', [InvestigasiController::class, 'update'])->name('update');
    ...
    Route::prefix('investigasipotensi')->name('investigasipotensi.')->group(function(){
        ...
        Route::put('update/{potensibahaya_id}', [ControllersInvestigasiPotensiController::class, 'update'])->name('update');
    ...
    Route::prefix('hirarc')->name('hirarc.')->group(function(){
        ...
        Route::get('tambahDetail', [HirarcController::class, 'tambahDetail'])->name('tambahDetail');
    ...
    Route::prefix('user')->name('user.')->group(function(){
        ...
        Route::put('save', [UserController::class, 'save'])->name('save');
