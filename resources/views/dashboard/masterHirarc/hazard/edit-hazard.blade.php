        ...
        <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  ">
            <div id="kt_app_content"
                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                    <form class="lh-lg" action="{{ route('hazard.update', $hzd->id) }}" method="POST">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-10 w-100">
                                        <input type="text" class="form-control" name="name" value="{{ $hzd->name }}">
                                    </div>
                                </div>
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class=" d-flex justify-content-center">
                                ...
                                <a href="{{ route('hazard.edit', ['id' => $id, 'id_hzd' => $hzd->id]) }}" type="submit"
