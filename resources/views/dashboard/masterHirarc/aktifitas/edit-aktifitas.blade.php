        ...
        <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  ">
            <div id="kt_app_content"
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                    <!--begin::Page title-->
                    <h2>Aktifitas</h2>
                    <a href="{{ route('aktifitas.detail', $id) }}" type="button"
                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                    <form class="lh-lg" action="{{ route('aktifitas.update', $act->id) }}" method="POST">
                        @csrf
                        <div class="card">
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class=" d-flex justify-content-center">
                                ...
                                <a href="{{ route('aktifitas.edit', ['id' => $id, 'id_act' => $act->id]) }}" type="submit"
