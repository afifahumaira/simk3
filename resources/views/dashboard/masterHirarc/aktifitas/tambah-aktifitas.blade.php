        ...
        <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  ">
            <div id="kt_app_content"
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                    <!--begin::Page title-->
                    <h2>Aktifitas</h2>
                    <a href="{{ route('aktifitas.index') }}" type="button"
                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                    <form class="lh-lg" action="{{ route('aktifitas.simpan') }}" method="POST">
                        @csrf
                        <div class="card ">
                            <div class="card-header d-flex align-items-center fs-3 fw-normal">
                                <div class="pull-left">
                                    <strong>Tambah Data Aktifitas</strong>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="lokasi" name="lokasi[]" class="form-select" data-control="select2" data-placeholder="Pilih Lokasi" multiple>
                                        ...
                                        @foreach ($locations as $loc)
                                            <option value="{{ $loc->id }}">{{ $loc->departemen->name }} ({{ $loc->name }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class=" d-flex justify-content-center">
                                ...
                                <a href="{{ route('aktifitas.tambah') }}" type="submit"
                                ...
                                <div class="modal fade" id="resetform" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered ">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center border-0">
                                                <a href="{{ route('aktifitas.tambah') }}" type="button"
                                                    class="btn btn-success text-white d-flex justify-content-center align-items-center text-center rounded-1"
                                                    style="width:76px; height:31px; background: #29CC6A;">Ya</a>
                                                <button type="button"
                                                    class="btn btn-secondary text-center d-flex align-items-center rounded-1"
