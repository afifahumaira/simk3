    ...
    <div class="page-title d-flex flex-column gap-1 mx-5 my-5  ">
        ...
        <div id="kt_app_content"
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                ...
                <!--end::Main wrapper-->
                <a href="{{ route('risiko.tambah') }}" type="button" class="btn btn-primary btn-sm"
                    ...
                    @foreach ($risks as $rks)
                        <tr>
                            <td scope="row" class="text-center">
                                {{ ($risks->currentpage() - 1) * $risks->perpage() + $loop->index + 1 }}</td>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="deleteForm{{ $rks->id }}" data-bs-backdrop="static"
            ...
            {{ $risks->links('pagination::customb5') }}
