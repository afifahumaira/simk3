        ...
        <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  ">
            <div id="kt_app_content"
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                    <!--begin::Page title-->
                    <h2>Departemen</h2>
                    <a href="{{ route('departemenmaster.index') }}" type="button"
                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                    <form class="lh-lg" action="{{ route('departemenmaster.simpan') }}" method="POST">
                        @csrf
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="inputNomertelepon3"
                                        class="col-sm-2 col-form-label required">Departemen</label>
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class=" d-flex justify-content-center">
                                <button type="submit"
                                    ...
                                    Data</button>
                                <a href="{{ route('departemenmaster.tambah') }}" type="submit"
