        ...
        <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  ">
            <div id="kt_app_content"
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                    <!--begin::Page title-->
                    <h2>Lokasi</h2>
                    <a href="{{ route('lokasimaster.detail', $loc->id) }}" type="button"
                    ...
                    <form class="lh-lg" action="{{ route('lokasimaster.update', $loc->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-10 w-100">
                                                <input type="text" class="form-control" name="lokasi" value="{{ $loc->name }}">
                                            </div>
                                        </div>
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class=" d-flex justify-content-center">
                                ...
                                <a href="{{ route('lokasimaster.update', $loc->id) }}" type="submit"
                                ...
                                <div class="modal fade" id="resetform" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered ">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center border-0">
                                                <a href="{{ route('lokasimaster.edit', $loc->id) }}"
                                                    type="button"
                                                    class="btn btn-success text-white d-flex justify-content-center align-items-center text-center rounded-1"
                                                    style="width:76px; height:31px; background: #29CC6A;">Ya</a>
                                                <button type="button"
