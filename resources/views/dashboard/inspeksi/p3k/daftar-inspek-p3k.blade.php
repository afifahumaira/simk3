    ...
    <div class="page-title d-flex justify-content-center flex-column gap-1 mx-5 my-5  ">
        ...
        <div id="kt_app_content"
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                ...
                <!--end::Main wrapper-->
                <a href="{{ route('p3kinspeksi.index') }} " type="button" class="btn btn-secondary text-white btn-sm"
            ...
            <table class="table table-bordered border-secondary px-3 py-3 mb-5 shadow">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Kotak P3K Tipe A</td>
                        <td>Teknik Komputer</td>
                        <td><a href="{{ route('lihat-inspek-p3k.index') }}" type="button" class="btn  btn-sm bg-warning "
                                style="width:20px;"><i
                                    class="bi bi-eye text-dark d-flex justify-content-center align-items-center"></i></a>
                            <a href="{{ route('inspek-p3k.index') }}" type="button" class="btn  btn-sm bg-primary"
                                style="width:20px;"><i
