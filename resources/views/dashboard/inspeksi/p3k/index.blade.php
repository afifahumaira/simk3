    ...
    <div class="page-title d-flex flex-column gap-1 mx-5 my-5  ">
        ...
        <div id="kt_app_content"
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                ...
                <!--begin::Main wrapper-->
                <!--end::Main wrapper-->
                <a href="{{ route('p3kinspeksi.daftar') }}" class="btn btn-primary  btn-sm mb-2 text-white" style="background: #233EAE">Daftar Inspeksi</a>
                <!--end::Title-->
            </div>
                ...
                <div id="kt_app_content"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center align-items-center"><a
                                        href="{{ route('p3kinspeksi.inspek', $item->id) }}" type="button"
                    ...
                    <div class="d-flex align-items-end justify-content-between pt-5 ">
                        <div class="col-sm-12 col-md-5">
                            <div class="dataTables_info" id="datatables_info" role="status" aria-live="polite">Showing 1 to
                                14 of 14 entries</div>
                        </div>
...
@section('customscript')
    <script>
        ...
        function update(){
                ...
                console.log(value);
                if (value != null) {
                    var url = "{{ route ('p3kinspeksi.selected_index',':value')}}";
