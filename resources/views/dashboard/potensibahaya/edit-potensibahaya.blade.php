                    ...
                    <form action="{{ route('potensibahaya.editstore', $data['id']) }}" method="POST">
                        ...
                        <div class="animated fadeIn mt-20 mb-10 ">
                            <div class="card ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <select class="form-select fs-6 w-100" data-control="select2"
                                                ...
                                                <option value="">- Pilih -</option>
                                                <option value="Fisik"
                                                    {{ $data->potensi_bahaya == 'Fisik' ? 'selected' : '' }}>Fisik</option>
                                                <option value="Kimiawi"
                                                    {{ $data->potensi_bahaya == 'Kimiawi' ? 'selected' : '' }}>Kimiawi
                                                </option>
                                                <option value="Biologis"
                                                    {{ $data->potensi_bahaya == 'Biologis' ? 'selected' : '' }}>Biologis
                                                </option>
                                                <option value="Ergonomi"
                                                    {{ $data->potensi_bahaya == 'Ergonomi' ? 'selected' : '' }}>Ergonomi
                                                </option>
                                                <option value="Psikologi"
                                                    {{ $data->potensi_bahaya == 'Psikologi' ? 'selected' : '' }}>Psikologi
                                                </option>
                                                <option value="Lainnya"
                                                    {{ $data->potensi_bahaya == 'Lainnya' ? 'selected' : '' }}>Lainnya
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ps-3 pe-5">
                                        <label for="inputUnit" class="col-sm-2 col-form-label">Resiko Bahaya</label>
                                        <div class="col-sm-10 w-100">
                                    ...
                                    <div class="ps-3 pe-5">
                                        <label for="inputUnit" class="col-sm-2 col-form-label">Usulan Perbaikan</label>
                                        <div class="col-sm-10 w-100">
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class=" d-flex justify-content-center">
                                ...
                                <a href="{{-- route('edit-potensibahaya.index') --}}" type="submit"
                                ...
                                <div class="modal fade" id="resetform" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered ">
                                        ...
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            ...
                                            <div class="modal-footer d-flex justify-content-center border-0">
                                                <a href="{{-- route('edit-potensibahaya.index') --}}" type="button"
                                                    class="btn btn-success text-white d-flex justify-content-center align-items-center text-center rounded-1"
                                                    style="width:76px; height:31px; background: #29CC6A;">Ya</a>
                                                <button type="button"
                                                    class="btn btn-secondary text-center d-flex align-items-center rounded-1"
