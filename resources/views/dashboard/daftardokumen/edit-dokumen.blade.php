        ...
        <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  ">
            <div id="kt_app_content"
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                    <!--begin::Page title-->
                    <h2>Dokumen</h2>
                    <a href="{{ route('daftardokumen.index') }}" type="button"
                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                  ...
                  <input class="form-control bg-secondary" name="kode_laporinsiden" id="kode_apar" value="ID NUMBER" readonly>
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <input type="text" class="form-control" name="name_file" id="lokasi_rinci"
                                    ...
                                    <div class="ps-3 pe-5 mb-0 pb-0">
                                        ...
                                        <div class="col-sm-10 w-100 mt-0 pt-0">
                                            <iframe src ="{{ asset('/laraview/#../berkas/'.$data->file) }}" width="1000px" height="600px"></iframe>
            ...
            height: 38px; margin : 10px 20px 30px 20px; font-size:14px; border-radius: 5px;"
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            ...
                            <a href="{{ route('daftardokumen.index') }}" type="submit"
