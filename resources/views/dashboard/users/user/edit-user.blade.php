                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                    <div id="kt_app_content"
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <form class="lh-lg" action="{{route ('user.update', $data->id)}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    {{-- <div class="ps-3 pe-5">
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <select class="form-select fs-6 w-100" data-control="select2"
                                                ...
                                                <option value="K3 Departemen" {{$data->hak_akses == 'K3 Departemen' ? 'selected' : ''}}>K3 Departemen</option>
                                                <option value="P2K3" {{$data->hak_akses == 'P2K3' ? 'selected' : ''}}>P2K3</option>
                                                <option value="Tamu" {{$data->hak_akses == 'Tamu' ? 'selected' : ''}}>Tamu</option>
