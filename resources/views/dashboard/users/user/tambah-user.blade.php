...
<div class="page-title d-flex flex-column gap-1 mx-5 my-5  ">
    ...
    <div class="page-title d-flex flex-column  gap-1 mx-5 my-5  " >    
        <div id="kt_app_content" class="app-content  rounded bg-light  mb-20 px-5 shadow"style="box-shadow: 2px 4px 20px 2px rgba(0, 0, 0, 0.1);"  >
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100 mb-5 px-5 border-bottom border-5">
                <!--begin::Page title-->
                <h2>Data User</h2>
                <a href="{{ route('user.index') }}"  type="button" class="btn  btn-sm btn-secondary text-white d-flex justify-content-center align-items-center mb-2" style="background: #505050; width:90px"><i class="bi bi-chevron-left text-white"></i>Kembali</a>
            </div>
          ...
          <form  class="lh-lg">
            {{-- <div class="ps-3 pe-5">
              ...
              <div class="ps-3 pe-5">
                  ...
                  <div class="col-sm-10 w-100">
                    <input type="text" class="form-control" name="lokasi_rinci" id="lokasi_rinci" value="" >
            ...
            <div class="ps-3 pe-5">
                ...
                <div class="col-sm-10 w-100">
                    <select class="form-select fs-6 w-100" data-control="select2" data-hide-search="true" data-placeholder="-Pilih-" style="--bs-link-hover-color-rgb: 25, 135, 84;" id="" style="font-family: 'Inter';">
    ...
    <div class="container d-flex justify-content-center">
        <div>
            ...
            <a style="margin: 30px" href="{{ route('tambahinsiden.index') }}" class="btn btn-secondary" type="reset"> Reset
            </a></div>
</div>
  </div>
</div>
