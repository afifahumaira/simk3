                            ...
                            @foreach ($laporaninsidens as $lap)
                                <tr>
                                    <td scope="row" class="text-center">
                                        {{ ($laporaninsidens->currentpage() - 1) * $laporaninsidens->perpage() + $loop->index + 1 }}</td>
                                    ...
                                    @if (auth()->user()->hak_akses == 'Pimpinan')
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <form id="editmodal" action="{{ route('laporan-insiden.edit') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <div class=" w-100">
                                            ...
                                            <input type="hidden" name="penyebab_insiden" id="penyebab_insiden">                                            
                                            <div id="additionalForm">
                                        <div class="ps-3 pe-5">
