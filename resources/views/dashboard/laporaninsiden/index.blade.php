                ...
                <table class="table table-rounded table-bordered">
                    ...
                    <tbody>
                        @foreach ($laporaninsidens as $lap)
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close" id="editmodal"></button>
                                                    </div>
                            ...
                            <!-- Delete modal -->
                            <div class="modal fade" id="deleteModal{{ $lap->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="deleteModalLabel{{ $lap->id }}" data-bs-backdrop="static"
