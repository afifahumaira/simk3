                ...
                <div class="page-title  gap-1 mx-5 my-5  ">
                            ...
                            <div class="card-body">
                                ...
                                <form class="lh-lg" method="POST"
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class=" w-100">
                                            <input class="form-control bg-secondary" name="laporinsiden_id"
                                                id="laporinsiden_id" value="{{ $investigasi->potensibahaya_id }}" readonly>
                                        </div>
                                    </div>
                                    <div class="ps-3 pe-5">
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <input type="text" class="form-control" name="risiko" id="risiko"
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <div class="form-group label-floating is-empty is-focused">
                                                <select name="p2k3" class="form-select fs-6 w-100"
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <input type="date" id="" name="tenggat_waktu"
                                                class="form-control tanggalPicker"
                                                value="{{ $investigasi->tenggat_waktu }}" placeholder="dd/mm/yyyy"
                    ...
                    <div class="container d-flex justify-content-center">
                        <div class=" d-flex justify-content-center">
                                        ...
                                        <div class="modal-body mt-5 d-flex justify-content-center align-items-center">
                                            <h2 class="mt-5 text-center"
                                                ...
                                                <p class="mb-0 mt-3 text-center "
                                                    ...
                                                    Status investigasi
                                                    akan berubah menjadi tuntas dan Investigasi diselesaikan
                                                </p>
                                            </h2>
                                        </div>
                            ...
                            <a href="{{ route('investigasipotensi.ubah', $investigasi->id) }}" type="submit"
