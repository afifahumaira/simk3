                                ...
                                <form action="{{ route('hirarc.save') }}" method="POST">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <div class="form-group label-floating is-empty is-focused">
                                                <input class="form-control bg-secondary" name="kode_laporinsiden"
                                                    id="kode_apar" value="Tegangan listrik tidak stabil" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <div class="form-group label-floating is-empty is-focused">
                                                <input class="form-control bg-secondary" name="kode_laporinsiden"
                                                    id="kode_apar" value="Merusak alat elektronik" readonly>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="">
                                                            {{-- {{ route('hirarc.simpanPreControl', ['id' => $detail->hirarc_id, 'detail_id' => $detail->id]) }} --}}
                                                            @csrf
                                            ...
                                            <div class="modal fade" id="PostControl" data-bs-backdrop="static"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="">
                                                            {{-- {{ route('hirarc.simpanPostControl', ['id' => $detail->hirarc_id, 'detail_id' => $detail->id]) }} --}}
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="form-group my-5">
                                                                    <label class="ps-3"
