        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_kapal').addEventListener('click', () => {
                    map.fitBounds([
                        [110.439917, -
                        7.05071850], // southwestern corner of the bounds -7.050718500263844, 110.43991719904835
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_industri').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44142729810034, -
                        7.051185046040615], // southwestern corner of the bounds -7.050718500263844, 110.43991719904835
                        [110.44155450155495, -
                        7.051113818088439], // northeastern corner of the bounds
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_arsitektur_gedung_a').addEventListener('click', () => {
                    map.fitBounds([
                        [110.4386441622901, -
                        7.051430638214809], // -7.051430638214809, 110.4386441622901
                        [110.43862270461872, -
                        7.051455926470208], // -7.051455926470208, 110.43862270461872
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_arsitektur_gedung_b').addEventListener('click', () => {
                    map.fitBounds([
                        [110.43841081010825, -
                        7.051137161254643], // -7.051137161254643, 110.43841081010825
                        [110.4384255622577, -
                        7.051169104334099], // -7.051169104334099, 110.4384255622577
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_arsitektur_gedung_c').addEventListener('click', () => {
                    map.fitBounds([
                        [110.4381446991714, -
                        7.051520591741523], // -7.051520591741523, 110.4381446991714
                        [110.43820446885938, -
                        7.051584386136422], // -7.051584386136422, 110.43820446885938
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_arsitektur_gedung_d').addEventListener('click', () => {
                    map.fitBounds([
                        [110.43800338887097, -
                        7.051025207034239], // -7.051025207034239, 110.43800338887097
                        [110.43798744036089, -
                        7.05105844561242], // -7.05105844561242, 110.43798744036089
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_dekanat_baru').addEventListener('click', () => {
                    map.fitBounds([
                        [110.43858712094622, -
                        7.05059540783121], // -7.05059540783121, 110.43858712094622
                        [110.43859784978218, -
                        7.0505974042760835], // -7.0505974042760835, 110.43859784978218
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_kimia_a').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44117489871748, -
                        7.052044054671596], // -7.052044054671596, 110.44117489871748
                        [110.44114910210155, -
                        7.052069656136314], // -7.052069656136314, 110.44114910210155
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_kimia_b').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44116759587276, -
                        7.052431694959633], // -7.052431694959633, 110.44116759587276
                        [110.44116156090254, -
                        7.052462972470875], // -7.052462972470875, 110.44116156090254
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_kimia_c').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44095459933877, -
                        7.053123199727869], // -7.053123199727869, 110.44095459933877
                        [110.4409720336972, -
                        7.053113883035895], // -7.053113883035895, 110.4409720336972
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_lab_pengolahlimbah').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44119894162314, -
                        7.051819313728907], // -7.051819313728907, 110.44119894162314
                        [110.44118955389169, -
                        7.0518233066080676], // -7.0518233066080676, 110.44118955389169
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_lab_kimiadasar').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44114990151887, -
                        7.051724335370081], // -7.051724335370081, 110.44114990151887
                        [110.441146518329, -
                        7.0517153817740335], // -7.0517153817740335, 110.441146518329
                    ]);
                });
            });
        ...
        map.on('load', () => {
            ...
            `)
                ...
                document.getElementById('fly_gkb').addEventListener('click', () => {
                    map.fitBounds([
                        [110.44027707962385, -
                        7.050573118819528], //  110.44038320745972, -7.051447597955487
                        [110.44028065360942, -
                        7.050564251420809], // 110.44038767984387, -7.051460913627565
                    ]);
                });
            });
