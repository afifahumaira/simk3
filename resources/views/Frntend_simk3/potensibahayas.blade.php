                    ...
                    <div class="content mt-3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="pull-left d-flex align-items-center">
                                        <strong>Lapor Potensi Bahaya</strong>
                                    </div>
                                </div>
                                        ...
                                        <div class="ps-3 pe-5">
                                            ...
                                            <div class="col-sm-10 w-100">
                                                <div class="form-group label-floating is-empty is-focused">
                                                    <input class="form-control" name="kode_laporinsiden"
                                                        id="kode_laporinsiden" value="PTNSBHYA-4" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="ps-3 pe-5">
                                            ...
                                            <div class="col-sm-10 w-100">
                                                <select class="form-select fs-6 w-100" data-kt-placement="bottom"
                                                    ...
                                                    <option value="Pingsan">Dosen</option>
                                                    <option value="Serangan Jantung">Karyawan</option>
                                                    <option value="Asma">Mahasiswa</option>
                                                    <option value="Pendarahan">Tamu</option>
                                                    <option value="Keracunan">Lainnya</option>
                                                </select>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="ps-3 pe-5">
                                        ...
                                        <div class="col-sm-10 w-100">
                                            <select class="form-select fs-6 w-100" data-control="select2"
                                                ...
                                                style="font-family: 'Inter';">
                                                <option value="">- Pilih -</option>
                                                <option value="Pingsan">Fisik</option>
                                                <option value="Serangan Jantung">Kimiawi</option>
                                                <option value="Asma">Biologis</option>
                                                <option value="Pendarahan">Ergonomi</option>
                                                <option value="Pendarahan">Psikologi</option>
                                                <option value="Keracunan">Lainnya</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ps-3 pe-5">
                                        <label for="inputUnit" class="col-sm-2 col-form-label">Deskripsi Potensi
                                            Bahaya</label>
                                        <div class="col-sm-10 w-100">
                                            <textarea class="form-control" id="kronologi"></textarea>
                                        </div>
                                    </div>
                                    <div class="ps-3 pe-5">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            ...
                                            <div class="modal-body mt-5 ">
                                                ...
                                                <p class="mb-0 mt-2 text-center "
                                                    style="color: #16243D; font-weight:400; font-size:14px"> Data
                                                    berhasil
                                                    diperbaharui! </p>
                                            </div>
                                ...
                                <a href="{{ route('simk3.index') }}" type="submit"
