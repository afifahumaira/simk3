...
<body>
                        ...
                        <div class="row ">
                            <div class="col-lg-10 col-xl-7 mx-auto ">
                                ...
                                <div class="">
                                    ...
                                    <p>Sudah Memiliki akun?<a href="f-lgn.html" class="font-italic text-muted">
                                            <u>Masuk</u></a></p>
                                </div>
                                <form>
                                    <div class="form-group mb-3">
                                        <input id="inputname" name="name" placeholder="Nama Pengguna" required=""
                                    ...
                                    <div class="form-group mb-3">
                                        <input id="inputPassword" type="password" placeholder="Konfirmasi Password"
                                            required="" class="form-control border-0 shadow-sm px-4 text-primary">
                                    </div>
    ...
    <style>
        ...
        .bg-image {
            background-image: url(../Arsha/assets/img/bg_lgn.jpg);
