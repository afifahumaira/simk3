@if ($message = Session::get('success'))
    <div class="alert alert-success alert-dismissible d-flex flex-column flex-sm-row w-100 p-5 mb-5">
        ...
        <div class="d-flex flex-column pe-0 pe-sm-10">
            <span class="fw-bolder">Berhasil</span>
            <span>{!! $message !!}</span>
        </div>
...
@if ($message = Session::get('error'))
    <div class="alert alert-danger alert-dismissible d-flex flex-column flex-sm-row w-100 p-5 mb-5">
        ...
        <div class="d-flex flex-column pe-0 pe-sm-10">
            <span class="fw-bolder">Peringatan</span>
            <span>{!! $message !!}</span>
        </div>
        <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" data-bs-dismiss="alert">
            <span class="svg-icon svg-icon-1 svg-icon-danger">
