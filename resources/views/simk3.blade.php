...
<body>
 ...
 {{-- end Modaal Gambar --}}
    ...
    <div style="display: none" id="showhide_industri">
        @foreach ($maps as $item)
            @if ($item->gedung == 'Teknik Industri')
                <li class="list-item inside gambargedung" data-img="{{ $item->gambar }}">{{ $item->lantai }} <img
                        id="mapsimg" src="{{ asset('foto_maps/foreign.png') }}"></li>
            @endif
        @endforeach
    </div>
    ...
    <button id="fly_arsitektur_gedung_a" class="list-item inside" onclick="floor_arsitektur_gedung_a()">Lantai Teknik
        Arsitektur Gedung A</button>
    ...
    <button id="fly_arsitektur_gedung_b" class="list-item inside" onclick="floor_arsitektur_gedung_b()">Lantai Teknik
        Arsitektur Gedung B</button>
    ...
    <button id="fly_arsitektur_gedung_c" class="list-item inside" onclick="floor_arsitektur_gedung_c()">Lantai Teknik
        Arsitektur Gedung C</button>
    ...
    <button id="fly_arsitektur_gedung_d" class="list-item inside" onclick="floor_arsitektur_gedung_d()">Lantai Teknik
        Arsitektur Gedung D</button>
    ...
    <button id="fly_dekanat_baru" class="list-item inside" onclick="floor_dekanat_baru()">Lantai Dekanat Fakultas
        Teknik</button>
    ...
    <button id="fly_lab_pengolahlimbah" class="list-item inside" onclick="floor_lab_pengolahlimbah()">Lantai
        Laboratorium Pengolah Limbah</button>
    ...
    <button id="fly_lab_kimiadasar" class="list-item inside" onclick="floor_lab_kimiadasar()">Lantai Laboratorium
        Kimia Dasar</button>
    ...
    <button id="fly_teknik_elektro_a" class="list-item inside" onclick="floor_elektro_gedung_a()">Lantai Teknik
        Elektro Gedung A</button>
    ...
    <button id="fly_elektro_b" class="list-item inside" onclick="floor_elektro_gedung_b()">Lantai Teknik Elektro
        Gedung B</button>
    ...
    <button id="fly_laboratorium_komputer" class="list-item inside"
        onclick="floor_laboratorium_komputer()">Laboratorium Komputer</button>
    ...
    <button id="fly_teknik_sipil_gedung_A" class="list-item inside" onclick="floor_sipil_a()">Lantai Teknik Sipil
        Gedung A</button>
    ...
    <button id="fly_teknik_sipil_gedung_B_C" class="list-item inside" onclick="floor_sipil_b_dan_c()">Lantai Teknik
        Sipil Gedung B & C</button>
    ...
    <button id="fly_teknik_sipil_gedung_D" class="list-item inside" onclick="floor_sipil_d()">Lantai Teknik Sipil
        Gedung D</button>
    ...
    <button id="fly_teknik_sipil_gedung_E" class="list-item inside" onclick="floor_sipil_e()">Lantai Teknik Sipil
        Gedung E</button>
    ...
    <button id="fly_teknik_mesin_gedung_A" class="list-item inside" onclick="floor_mesin_a()">Lantai Teknik Mesin
        Gedung A</button>
    ...
    <button id="fly_teknik_mesin_gedung_B" class="list-item inside" onclick="floor_mesin_b()">Lantai Teknik Mesin
        Gedung B</button>
    ...
    <button id="fly_teknik_mesin_lab_tribologi" class="list-item inside" onclick="floor_mesin_b()">Lantai
        Laboratorium Tribologi</button>
    <div style="display: none" id="showhide_mesin_b">
        @foreach ($maps as $item)
    ...
    <button id="fly_teknik_mesin_laboratorium" class="list-item inside" onclick="floor_mesin_b()">Lantai Gedung
        Teknik Mesin</button>
    <div style="display: none" id="showhide_mesin_b">
        @foreach ($maps as $item)
