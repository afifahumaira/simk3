        ...
        <script>
            ...
            map.on('load', () => {
                ...
                map.on('click', 'gedung_dekanat_lama', (e) => {
                    new mapboxgl.Popup()
                        .setLngLat(e.lngLat)
                        .setHTML(`<h1>Gedung Teknik Geodesi & Teknik Komputer</h1>
                            <button id="fly_dekanat_lama" class="list-item inside" onclick="floor_dekanat_lama()">Gedung Dekanat FakultasTeknik Lama </button>
                            ...
                            <button id="fly_laboratorium_komputer" class="list-item inside" onclick="floor_laboratorium_komputer()">Gedung Laboratorium Komputer</button>
